...
/**
 * The course class is a class that implements the Serializable interface and represents a teacher.
 * It contains information such as the teacher's name, what classes can be taught, teacher id, etc.
 *
